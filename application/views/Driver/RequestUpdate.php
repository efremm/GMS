      ...
      <section class="dashboard-counts section-padding">
        <div class="container">
          <div class="row">
            ...
            <!-- body-->
              <form   method="post" action="<?php echo base_url()?>Driver_C/update_request" enctype="multipart/form-data" accept-charset="utf-8">
                 ...
                 <div class="form-label-group col-lg-4">
                        ...
                        <input  type="text" class="form-control bg-success text-danger" id="requestername" name="requestername" placeholder="requestername"  autofocus value="<?php echo $this->session->userdata('username');?>" readonly>
                        <span class="text-danger"><?php echo form_error("requestername"); ?></span>
                    </div>
                 <div class="form-label-group col-lg-4">
                        <label for="plateno">Plate No</label>
                        <input  type="text" class="form-control" id="plateno" name="plateno" placeholder="plateno"  value="<?php echo $row->plate_no; ?>" autofocus>
                        <span class="text-danger"><?php echo form_error("plateno"); ?></span>
                    </div>
                   
                    <div class="form-label-group col-lg-4">
                        <label for="location">Loaction</label>
                        <input  type="text" class="form-control" id="location" name="location" placeholder="location" value="<?php echo $row->location; ?>"  autofocus>
                        <span class="text-danger"><?php echo form_error("location"); ?></span>
                    </div>
                     <div class="form-label-group col-lg-4">
                        <label for="issue">Issue</label>
                        <input  type="text" class="form-control" id="issue" name="issue" placeholder="issue" value="<?php echo $row->issue; ?>" autofocus>
                        <span class="text-danger"><?php echo form_error("issue"); ?></span>
                    </div>
                     <div class="form-label-group col-lg-4">
                        <label for="requestdate">Requested Date</label>
                        <input  type="text" class="form-control" id="requestdate" name="requestdate" placeholder="requestdate" value="<?php echo $row->requested_date; ?>" autofocus>
                   ...
                   <!--   <div class="form-label-group col-lg-4">
                     ...
                     <td><img src="<?php echo base_url();?>./images/<?php echo $row->vehicle_image;?>" style="width: 100px;"></td>
                      <span class="text-danger"><?php echo form_error("uploadimage"); ?></span>
                     </div> 
                   
                   <div class="col-lg-12 text-danger bg-warning"> </hr><p>Approval Part</p></div>
                 ...
                 <div class="form-label-group col-lg-4">
                    ...
                    <div class="form-label-group col-lg-4">
                        ...
                        <input  type="text" class="form-control text-danger" id="approval_description" name="approval_description" placeholder="approval_description" value="<?php echo $row->approval_description; ?>"  autofocus readonly>
                     ...
                     <div class="form-label-group col-lg-4">
                      ...
                      <div class="form-label-group col-lg-4">
                        ...
                        <input  type="text" class="form-control  text-danger" id="assigned_date" name="assigned_date" placeholder="assigned_date" value="<?php echo $row->vehicle_image; ?>" autofocus readonly>
                     ...
                     <div class="form-label-group col-lg-4">
                        ...
                        <input type="submit" value="Update" class="btn btn-info" name="update"/>
                            ...
                            <?php echo anchor('Driver_C/RequestRegManage','Back',['class'=>'btn btn-defualt']);?>
