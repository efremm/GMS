    ...
    <nav class="side-navbar">
      <div class="side-navbar-wrapper">
        ...
        <div class="sidenav-header d-flex align-items-center justify-content-center">
          ...
          <div class="sidenav-header-logo"><a href="index.html" class="brand-small text-center"> <strong>GMS</strong><strong class="text-primary">D</strong></a></div>
        </div>
          ...
          <div class="row">
            <!-- body-->
               ...
               <div class="row col-lg-12" style="background-color: grey;">
                    <p><h3><strong>
                      Driver Dashboard</strong></h3>
                    </p>
                  </div>
                  <hr>
    <div class="row col-lg-12">
        <div class="card text-white bg-primary col-lg-4">
            <div class="card-header"><h3><strong>Total Driver</strong></h3></div>
            <div class="card-body">
                
              <!-- <div class="count-number text-primary"><?php echo $cnt_driver;?></div> -->
              <td><?php echo $cnt_driver;?></td>
            </div>
        </div>
        <div class="card text-white bg-primary col-lg-4">
            <div class="card-header"><h3><strong>Total Vehicle</strong></h3></div>
            <div class="card-body">
                <!-- <h5 class="card-title">Inactive Driver</h5> -->
                <td><?php echo $cnt_vehicle;?></td>
            </div>
        </div>
      
      <div class="card text-white bg-primary col-lg-4">
            <div class="card-header"><h3><strong>Total Service</strong></h3></div>
            <div class="card-body">
                <!-- <h5 class="card-title">Currently in Use</h5> -->
                <!-- <p>Can update Delete And Create System Users</p> -->
                <td><?php echo $cnt_service;?></td>
            </div>
        </div>
         </div>
              <style>
