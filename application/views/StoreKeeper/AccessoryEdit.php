                 ...
                 <div class="container row">
                  ...
                  <div class="form-label-group col-lg-4">
                    ...
                    <div class="form-label-group col-lg-4">
                        ...
                        <input  type="text" class="form-control  text-danger" id="supplier" name="supplier" placeholder="supplier"  value="<?php echo $row->supplier; ?>" autofocus  >
                        <span class="text-danger"><?php echo form_error("supplier"); ?></span>
                    </div>
                    <div class="form-label-group col-lg-4">
                        <label for="store_receiver">Store Receiver</label>
                        <input  type="text" class="form-control bg-success" id="storereceiver" name="storereceiver" placeholder="storereceiver"  style="colour:blue" autofocus value="<?php echo $this->session->userdata('username');?>"  >
                        <span class="text-danger"><?php echo form_error("storereceiver"); ?></span>
                    </div>
                     <div class="form-label-group col-lg-4">
                        <label for="partno">part no</label>
                        <input  type="text" class="form-control" id="partno" name="partno" placeholder="partno"  style="colour:blue" autofocus value="<?php echo $row->unit_price; ?>"  >
                    ...
                    <div class="form-label-group col-lg-4">
                      ...
                      <div class="form-label-group col-lg-4">
                        ...
                        <input  type="text" class="form-control" id="availablequantity" name="availablequantity" placeholder="availablequantity"  autofocus value="<?php echo $row->available_quantity; ?>" >
                    ...
                    <div class="form-label-group col-lg-4">
                      ...
                      <div class="col-lg-12"><h2 class="text-warning bg-danger">Approval Part</h2></div>
                  
                    <div class="form-label-group col-lg-4">
                        <label for="requestername">Requester Name</label>
                        <input  type="text" class="form-control text-danger bg-success" id="requestername" name="requestername" placeholder="requestername"  style="colour:blue" autofocus readonly value="<?php echo $row->requester_name; ?>">
                    ...
                    <div class="form-label-group col-lg-4">
                        ...
                        <input  type="text" class="form-control" id="serviceno" name="serviceno" placeholder="serviceno"  autofocus readonly value="<?php echo $row->service_no; ?>">
                    ...
                    <div class="form-label-group col-lg-4">
                     ...
                     <div class="col-lg-12"><h2 class="text-warning bg-info">Approver Part</h2></div>
                        ...
                        <select class="form-control text-success" disabled id="approval_status" name="approval_status" >
                             <option readonly >-select approval_status-</option>
                     ...
                     <div class="form-label-group col-lg-4">
                        ...
                        name="approver_name" placeholder="approver_name" 
                         style="colour:blue" autofocus readonly  value="<?php echo $this->session->userdata('username');?>" >
                        <span class="text-danger"><?php echo form_error("approver_name"); ?></span>
                    </div>
                    <div class="form-label-group col-lg-4">
                        <label for="approved_date">approved_date</label>
                        <input  type="text" class="form-control" id="approved_date" name="approved_date" placeholder="approved_date"  autofocus readonly>
                        <span class="text-danger"><?php echo form_error("approved_date"); ?></span>
                    </div>
                    <div class="form-label-group col-lg-4">
                        <label for="approved_quantity">approved_quantity</label>
                        <input  type="text" class="form-control" id="approved_quantity" name="approved_quantity" placeholder="approved_quantity"  autofocus readonly>
                        <span class="text-danger"><?php echo form_error("approved_quantity"); ?></span>
                    </div>
