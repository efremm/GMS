        ...
        <div class="admin-menu">
         <hr>
          <ul id="side-admin-menu" class="side-menu list-unstyled"> 
                  <li><a class="icon-interface-windows" href="<?php echo base_url('Authentication/logout')?>"><i class="fa fa-power-off"></i>Logout</a></li>
          ...
          <div class="row">
            <!-- body-->
              ...
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><strong class="text-uppercase">New Vehicle</strong><span>Last 7 days</span>
            ...
            <div class="col-xl-2 col-md-4 col-6">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><strong class="text-uppercase">Work On Progress</strong><span>Last 5 days</span>
            ...
            <div class="col-xl-2 col-md-4 col-6">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><strong class="text-uppercase">Total Member Registration</strong><span>Last 2 months</span>
                  <div class="count-number">34</div>
                </div>
              </div>
            </div>
            <!-- Count item widget-->
            <div class="col-xl-2 col-md-4 col-6">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><strong class="text-uppercase">Total Inventery</strong><span>Last 2 days</span>
            ...
            <div class="col-xl-2 col-md-4 col-6">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><strong class="text-uppercase">Total Driver</strong><span>Last 3 months</span>
            ...
            <div class="col-xl-2 col-md-4 col-6">
              <div class="wrapper count-title d-flex">
                ...
                <div class="name"><strong class="text-uppercase">Over All Tasks</strong><span>Last 7 days</span>
