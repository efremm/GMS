      ...
      <section class="dashboard-counts section-padding">
        <div class="container">
          <div class="row">
            ...
            <!-- body-->
               <form   method="post" action="<?php echo base_url()?>Driver_C/SendRequest" enctype="multipart/form-data" accept-charset="utf-8">
                 <div class="container row">
       <div class="col-lg-12"> <h4 style="font-family: sans-serif;">Request Help Form</h4></div>
           <hr>
            ...
            <!-- <?php echo $error;?> -->
              <?php if($scsmsg = $this->session->flashdata('successmsg'));?>
                 ...
                 <div class="form-label-group col-lg-4">
                        ...
                        <input  type="text" class="form-control" id="plateno" name="plateno" placeholder="plateno"  autofocus>
                        <span class="text-danger"><?php echo form_error("plateno"); ?></span>
                    </div>
                   
                    <div class="form-label-group col-lg-4">
                        <label for="location">Loaction</label>
                        <input  type="text" class="form-control" id="location" name="location" placeholder="location"  autofocus>
                        <span class="text-danger"><?php echo form_error("location"); ?></span>
                    </div>
                     <div class="form-label-group col-lg-4">
                        <label for="issue">Issue</label>
                        <input  type="text" class="form-control" id="issue" name="issue" placeholder="issue"  autofocus>
                        <span class="text-danger"><?php echo form_error("issue"); ?></span>
                    </div>
                     <div class="form-label-group col-lg-4">
                        <label for="requestdate">Requested Date</label>
                        <input  type="date" class="form-control" id="requestdate" name="requestdate" placeholder="requestdate"  autofocus>
                        <span class="text-danger"><?php echo form_error("requestdate"); ?></span>
                    </div>
                   <!--  <div class="form-label-group col-lg-4">
                       <label for="uploadimage">Upload Vehicle Image</label>
                     <input type="text" id="uploadimage" name="uploadimage" size="33" />
          ...
          <!--   <form   method="post" action="<?php echo base_url()?>Driver_C/SaveImage" enctype="multipart/form-data" accept-charset="utf-8"> -->
              <!-- <?php echo $error;?> -->

               <!--  <?php echo form_open_multipart('Driver_C/do_upload');?>
