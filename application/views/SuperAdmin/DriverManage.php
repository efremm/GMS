        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="container">
                   ...
                   <div class="col-lg-12">  
                   <?php echo anchor('Encoder_C/DriverReg','Add Driver',['class'=>'btn btn-info']);?>
                  </div>
                     <hr>
                     <div class="container">
                          <table id="tbll"  name="tbll" class="table table-responsive table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td><?php echo $post->licence_no;?></td>
                                <td><?php echo $post->first_name . ' ' . $post->middle_name . ' ' . $post->last_name;?></td>
                                 <td><?php echo $post->gender;?></td>
                                <td><?php echo $post->licence_renewal_date;?></td>
                                <td><?php echo $post->address;?></td>
                                <td><?php echo $post->phone_no;?></td>
                                  <td><?php echo $post->hired_date;?></td>                          
                              <td> <?php echo anchor("Encoder_C/update_driver_fetch/{$post->driver_id}",'<span class="fa fa-edit"></span>',['class'=>'btn btn-info']);?></td>
                                 <td> <a class="delete_data btn btn-danger" href="#" id="<?php echo $post->driver_id; ?>"><span class="fa fa-trash"></span></a> </td>
          ...
          $('.delete_data').click(function()
           {
            ...
            if(confirm("Are you sure you want to delete this"))
                {
                   window.location="<?php echo base_url(); ?>Encoder_C/delete_driver_c/"+driverdata;
                }     
                else
                {
                  return false;
