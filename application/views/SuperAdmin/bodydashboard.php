    ...
    <nav class="side-navbar">
      <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
          ...
          <li> <a class="fa fa-user" href="<?php echo base_url('Encoder_C/MemberRegManage')?>"><i class=""></i>Member Registration</a></li>
           
          <li> <a class="fa fa-user" href="<?php echo base_url('Encoder_C/DriverReg')?>"><i class=""></i>Driver Registration</a></li>
          <li> <a class="fa fa-bus" href="<?php echo base_url('Encoder_C/VehicleAssignment')?>"><i class=""></i>Vihicle Registration</a></li>
