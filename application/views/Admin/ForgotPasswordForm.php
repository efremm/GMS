        ...
        <div class="container">
          ...
          $value=$this->session->userdata('KEY');
            ?> -->
                  ...
                  <div class="col-lg-12"> <h4 style="font-family: sans-serif;">Edit User</h4></div>
                        <hr>
                ...
                <form   method="post" action="<?php echo base_url()?>Authentication/check_security_qn">
               
                <div class="container row">
                 <!-- <?php $values=$this->input->post('username'); ?> -->
                   <!-- $first_name = $this->input->post('first_name'); # if method is post -->
                  <!--  "<?php echo $row->user_id; ?>"   -->
                   <!-- $values="<?php echo $this->session->userdata('KEY'); ?>" -->
                 ...
                 <!-- value=" <?php echo $this->session->userdata('username');?> " -->
                     <div class="form-label-group col-lg-6" >
                        <label for="seq_qsn">Sequrity Question</label>
                        <select class="form-control text-success"  id="seq_qsn" name="seq_qsn" >
                             <option readonly >-select sequrity question-</option>
                            ...
                            <option value="What is Your Uncle Name">What is Your Uncle Name</option>
                             <option value="What is Your Nick Name Subject">What is Your Nick Name</option>
                        </select>
                        <span class="text-danger"><?php echo form_error("approval_status"); ?></span>
                    </div>
                    <div class="form-label-group col-lg-4">
                        <label >Answer for Sequrity Question </label>
                        <input  type="text" class="form-control  text-danger" id="answer_sq" name="answer_sq" placeholder="answer_sq" 
                          autofocus  >
                       </div>
