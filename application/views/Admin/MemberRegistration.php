...
<div class="container">
    <div class="row">
        ...
        <div class="col-lg-12">
             <table id="mytabledata" name="mytabledata" class="table table-striped table-bordered" style="width:100%">
            <!-- <table class="table table-striped" id="mytabledata" name="mytabledata"> -->
                <thead>
                <tr>
                    <th>Member ID</th>
                    <th>Title</th>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="form-label-group col-lg-4">
                            <label for="member_id">የአባሉ መታወቅያ</label>
                            <input type="text" class="form-control" id="member_id" name="member_id" placeholder="Insert Member ID" required autofocus>
                        </div>
                    <div class="form-label-group col-lg-4">
                    ...
                    <div class="form-label-group col-lg-4">
                        ...
                        <input type="text" class="form-control" id="first_name" name="first_name" placeholder="Insert user name" required autofocus>
                    </div>
                    <div class="form-label-group col-lg-4">
                    ...
                    <div class="form-label-group col-lg-4">
                        ...
                        <input type="text" class="form-control" id="last_name" name="last_name" placeholder="Middle Name" required autofocus>
                    </div>
                    <div class="form-label-group col-lg-4">
                        <label for="age">Age</label>
                        <input type="text" class="form-control" id="age" name="age" placeholder="Age" required autofocus>
                    </div>
                    <div class="form-label-group col-lg-4">
                    ...
                    <div class="form-label-group col-lg-4">
                        ...
                        <input type="text" class="form-control" id="salary" name="salary" placeholder="salary" required autofocus>
                    </div>
                    <div class="form-label-group col-lg-4">
                        <label for="datepicker1">Date</label>
                        <input  data-type="date" class="form-control" id="datepicker1" name="datepicker1" placeholder="date" required autofocus>
                    </div>
                </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-label-group col-lg-4">
                            ...
                            <select class="form-control" id="title_edit" name="title_edit">
                                <option value="">-select titl-</option>
                        ...
                        <div class="form-label-group col-lg-4">
                            ...
                            <select class="form-control" id="department_edit" name="department_edit">
                                ...
                                <option value="TvDepartment">TvDepartment</option>
                                <option value="RadioDepartment">RadioDepartment</option>
                                <option value="JournalDepartment">JournalDepartment</option>
                            </select>
                        </div>
