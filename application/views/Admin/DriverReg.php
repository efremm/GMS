      ...
      <section class="dashboard-counts section-padding">
        <div class="container">
          <div class="row">
            ...
            <!-- body-->
               <form   method="post" action="<?php echo base_url()?>Encoder_C/AddDriver">
                 <div class="container row">
       <div class="col-lg-12"> <h4 style="font-family: sans-serif;">Driver Registration</h4></div>
           <hr>
          <div class="container  " style="background-color: green;">
              <?php if($scsmsg = $this->session->flashdata('successmsg'));?>
               ...
               <div class="form-label-group col-lg-4">
                        ...
                        <input type="text" class="form-control" id="licenceno" name="licenceno" placeholder="Insert licence no"  autofocus>
                    ...
                    <div class="form-label-group col-lg-4">
                        <label for="licrenewaldt">Renewal Date</label>
                        <input type="date" class="form-control" id="licrenewaldt" name="licrenewaldt" placeholder="licrenewaldt"  autofocus>
                        <span class="text-danger"><?php echo form_error("licrenewaldt"); ?></span>
                    </div>
                     <div class="form-label-group col-lg-4">
