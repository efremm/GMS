    ...
    <div class="page">
      ...
      <section class="dashboard-counts section-padding">
        <div class="container">
          <div class="row">
            <!-- body-->
               <form   method="post" action="<?php echo base_url()?>Admin_C/add" enctype="multipart/form-data" accept-charset="utf-8">
        ...
        <input type="password" placeholder="Password" name="password">
         <span class="text-danger"><?php echo form_error("password"); ?></span> 
          ...
          <div class="form-group">
                        ...
                        <select class="form-group" id="usertype" name="usertype">
                   ...
                   <div class="form-group">
                               ...
                               <input type="file" id="uploadimage" name="uploadimage" size="33" placeholder="your image" />
                                <span class="text-danger"><?php echo form_error("uploadimage"); ?></span> 
                  </div>
                  <div class="form-group">
                    <i class="fa fa-key icon"></i>
                    <input type="empid" placeholder="empid" name="empid" id="empid">
