      ...
      <section class="dashboard-counts section-padding">
        <div class="container">
          <div class="row">
            ...
            <!-- body-->
              <form   method="post" action="<?php echo base_url()?>Admin_C/update_technical_help">
                 ...
                 <!-- value="<?php echo $this->session->userdata('case_id');?>" -->
                 <div class="form-label-group col-lg-4">
                        <label for="caseid">caseid</label>
                        <input  type="text" class="form-control bg-success text-danger" id="caseid" name="caseid" placeholder="caseid"  value="<?php echo $row->case_id; ?>" autofocus  readonly>
                        <span class="text-danger"><?php echo form_error("caseid"); ?></span>
                    </div>
                 <div class="form-label-group col-lg-4">
                        <label for="casename">case_name</label>
                        <input  type="text" class="form-control" id="casename" name="casename" placeholder="casename"  value="<?php echo $row->case_name; ?>" autofocus>
                        <span class="text-danger"><?php echo form_error("casename"); ?></span>
                    </div>
                   
                    <div class="form-label-group col-lg-4">
                        <label for="casetype">case_type</label>
                        <input  type="text" class="form-control" id="casetype" name="casetype" placeholder="casetype" value="<?php echo $row->case_type; ?>"  autofocus>
                        <span class="text-danger"><?php echo form_error("casetype"); ?></span>
                    </div>
                     <div class="form-label-group col-lg-4">
                        <label for="solution">case solution</label>
                        <textarea type="text" class="form-control" id="solution" name="solution" placeholder="solution" value="<?php echo $row->case_solution; ?>" autofocus><?php echo $row->case_solution; ?></textarea> 
                        <span class="text-danger"><?php echo form_error("solution"); ?></span>
                    </div>
                     <div class="form-label-group col-lg-4">
                        <label for="issuedate">issue_date</label>
                        <input  type="text" class="form-control" id="issuedate" name="issuedate" placeholder="issuedate" value="<?php echo $row->issue_date; ?>" autofocus>
                        <span class="text-danger"><?php echo form_error("issuedate"); ?></span>
                    </div>
                    
                            <div class="form-group col-lg-12">
                         <input type="hidden" name="hidden_id" value="<?php  echo $row->case_id;?>" required>
                        <input type="submit" value="Update" class="btn btn-info" name="update"/>

                            <?php echo anchor('Admin_C/update_technical_help','Back',['class'=>'btn btn-defualt']);?>
