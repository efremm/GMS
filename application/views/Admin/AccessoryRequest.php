      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="sidenav-header d-flex align-items-center justify-content-center">
          ...
          <div class="sidenav-header-inner text-center"><img src="<?php echo base_url('/images/icon.PNG'); ?> "  alt="person" class="img-fluid rounded-circle">
            <h2 class="h5">GMN</h2><span>@AAPC</span>
          </div>
      ...
      <section class="dashboard-counts section-padding">
        <div class="container">
          <div class="row">
            ...
            <!-- body-->
              <form   method="post" action="<?php echo base_url()?>Technician_C/SendAccessoryRequest">
                 <div class="container row">
                  <div class="col-lg-12"> <h4 style="font-family: sans-serif;">Request Accessory</h4></div>
                       <hr>
                   ...
                   if(isset($fetch_data))
                       {
                         foreach ($fetch_data as $row) 
                         {
                            ...
                            ?> 
                         <div class="col-lg-12"><h2 class="text-warning bg-danger">Available Accessory</h2></div>  
                  ...
                  <div class="form-label-group col-lg-4">
                    ...
                    <div class="form-label-group col-lg-4">
                        ...
                        <input  type="text" class="form-control text-danger bg-success" id="requestername" name="requestername" placeholder="requestername"  style="colour:blue" autofocus  
                     ...
                     <div class="form-label-group col-lg-4">
                        ...
                        <input  type="text" class="form-control" id="requiredquantity" name="requiredquantity" placeholder="requiredquantity"  style="colour:blue" autofocus  value="<?php echo $row->required_quantity; ?>">
                        <span class="text-danger"><?php echo form_error("requiredquantity"); ?></span>
                    </div>

                    <div class="form-label-group col-lg-4">
                        <label for="requesteddate">Requested Date</label>
                        <input  type="date" class="form-control" id="requesteddate" name="requesteddate" placeholder="requesteddate"  autofocus   value="<?php echo $row->requested_date; ?>">
                        <span class="text-danger"><?php echo form_error("requesteddate"); ?></span>
                    </div>
                    <div class="form-label-group col-lg-4">
                        <label for="serviceno">Service_NO</label>
                        <input  type="text" class="form-control" id="serviceno" name="serviceno" placeholder="serviceno"   autofocus  value="<?php echo $row->service_no; ?>">
                     ...
                     <div class="form-label-group col-lg-4">
                        ...
                        name="approver_name" placeholder="approver_name" 
                         style="colour:blue" autofocus readonly  value="<?php echo $row->approver_name; ?>" >
                        <span class="text-danger"><?php echo form_error("approver_name"); ?></span>
                    </div>
                    <div class="form-label-group col-lg-4">
                        <label for="approved_date">approved_date</label>
                        <input  type="text" class="form-control" id="approved_date" name="approved_date" placeholder="approved_date"  autofocus readonly value="<?php echo $row->approved_date; ?>" >
                        <span class="text-danger"><?php echo form_error("approved_date"); ?></span>
                    </div>
                    <div class="form-label-group col-lg-4">
                        <label for="approved_quantity">approved_quantity</label>
                        <input  type="text" class="form-control" id="approved_quantity" name="approved_quantity" placeholder="approved_quantity"  autofocus readonly value="<?php echo $row->approved_quantity; ?>" >
                        ...
                        <input type="submit" value="Update" class="btn btn-info" name="update"/>
                            ...
                            <?php echo anchor('Technician_C/TechnicianDashboard','Back',['class'=>'btn btn-defualt']);?>
