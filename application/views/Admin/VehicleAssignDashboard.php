                          ...
                          <table id="tbll"  name="tbll" class="table table-responsive table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td class="text-warning"><?php echo $post->assigned_to_driver;?></td>
                                                        
                               <!--  <td> <?php echo anchor("StoreKeeper_C/vehicle_assignment_fetch/{$post->plate_no}",'<span class="fa fa-edit"></span>',['class'=>'btn btn-warning']);?></td>  -->
