        ...
        <div class="card">
            ...
            <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                <div class="card-body">
                        ...
                        <p>
             <li>AAPC  ---->          Addis Ababa Police Commusion</li>
            <li>GMS    ---->                 Garage Management System</li>
                     ...
                     <div class="container">
                          <table id="tbluser"  name="tbluser" class="table table-responsive table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                              ...
                              <td> <?php echo anchor("Admin_C/sys_help_fetch/{$post->syshelp_id}",'<span class="fa fa-edit"></span>',['class'=>'btn btn-info']);?></td>
  ...
  <script type="text/javascript">
       $(document).ready(function() {
          $('.delete_data').click(function()
           {
            var sysdata=$(this).attr("id");
            if(confirm("Are you sure you want to delete this"))
                {
                   window.location="<?php echo base_url(); ?>Admin_C/delete_syshelp_c/"+sysdata;
                }     
                else
                {
                  return false;
