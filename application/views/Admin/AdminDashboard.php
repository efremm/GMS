           ...
           <link rel="stylesheet" type="text/css" href="<?php echo base_url().'assets/sidemenu/css/style.blue.css'?>">
            ...
            <link rel="stylesheet" type="text/css" href="<?php echo base_url().'assets/sidemenu/css/style.green.css'?>">
             <link rel="stylesheet" type="text/css" href="<?php echo base_url().'assets/sidemenu/css/fontastic.css'?>">
              ...
              <!-- chart -->
             <!--  <link rel="stylesheet" type="text/css" href="<?php echo base_url().'assets/charts/bootstrap.min.css'?>"> -->
               <!-- <link rel="stylesheet" type="text/css" href="<?php echo base_url().'assets/charts/css/light-bootstrap-dashboard.css'?>">
                <link rel="stylesheet" type="text/css" href="<?php echo base_url().'assets/charts/css/demo.css'?>"> -->
                            ...
                            <ul class="navbar-nav mr-auto">
                                ...
                                <li class="nav-item dropdown">
                                  ...
                                  <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                     <?php if(count($fetchimage)):?>
                                   <?php foreach($fetchimage as $posts):?>
                                     <?php echo $this->session->userdata('username');?>
                                      <td><img src="<?php echo base_url();?>./images/<?php echo $posts->user_image;?>" style="width: 20px;"></td>
                                       <?php endforeach;?>
                                     <?php else: ?>
                                      <?php endif;?>
                                  </a>
        ...
        <div class="container-fluid">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                          <div class="card">
                            ...
                            <div class="body">
                               <!-- <div id="chart_div" style="height: 285px"></div> -->
                                <div id="chart_status" style="width: 500px; height: 300px;"></div>
                             </div>
                            </div>
                          </div>
                     <!-- </div> -->
          ...
          <div class="row col-lg-12">
              ...
              <div class="card text-white bg-primary col-lg-3">
                  <div class="card-header"><h3><strong>All Users</strong></h3></div>
                  <div class="card-body">
              ...
              <div class="card text-white bg-primary col-lg-3">
                  <div class="card-header"><h3><strong>Active Users</strong></h3></div>
                  <div class="card-body">
                      <!-- <h5 class="card-title"> Active Users</h5> -->
                    <td><?php echo $countactive;?></td> 
                  </div>
              </div>
              <div class="card text-white bg-primary col-lg-3">
                  <div class="card-header"><h3><strong>Inactive Users</strong></h3></div>
                  <div class="card-body">
                      <!-- <h5 class="card-title">Inactive Users</h5> -->
                      <td class="text-danger"><?php echo $countinactive;?></td>
                  </div>
              </div>
   ...
   <script src="<?php echo base_url(); ?>assets/charts/loader.js"></script>
              ...
              <script type="text/javascript">
                   // Load the Visualization API and the corechart package.
                        ...
                        function drawChart() {
                          ...
                          data.addColumn('number', 'total_user');

                          data.addRows([
                                <?php
                                    foreach ($charttype as $v)
                                    {
                                       echo "['".$v['user_type']."', ".$v['total_user']."],";
                                    }
                                    ?>
                          ]);

                          // Set chart options
                          var options = {'title':'All User Type',
                                         'width':400,
                                         'height':300};
            ...
            <script type="text/javascript">
                ...
                function drawChart() {
                          ...
                          // Create the data table.
                          var data = new google.visualization.DataTable();
                          data.addColumn('string', 'user number');
                          data.addColumn('number', 'user status');
                          data.addRows([
                                <?php
                                    foreach ($chartstatus as $v)
                                    {
                                       echo "['".$v['user_status']."', ".$v['total_user']."],";
                                    }
                                    ?>
                          ]);

                          // Set chart options
                          var options = {'title':'All User Status',
                                         'width':450,
                                         'height':300};
