    ...
    <div class="page">
      ...
      <section class="dashboard-counts section-padding">
        <div class="container">
          <div class="row">
            <!-- body-->
               <form   method="post" action="<?php echo base_url()?>Admin_C/SubmitCase">
          ...
          <div class="container  " style="background-color: green;">
              <?php if($scsmsg = $this->session->flashdata('successmsg'));?>
                    ...
                    <div class="form-label-group col-lg-4">
                        ...
                        <input  type="text" class="form-control" id="case_name" name="case_name" placeholder="case_name"  autofocus>
                        <span class="text-danger"><?php echo form_error("case_name"); ?></span>
                    </div>
                    <div class="form-label-group col-lg-4">
                        <label for="case_type">Case Type</label>
                        <input  type="text" class="form-control" id="case_type" name="case_type" placeholder="case_type"  autofocus>
                        <span class="text-danger"><?php echo form_error("case_type"); ?></span>
                    </div>
                    <div class="form-label-group col-lg-4">
                        <label for="case_solution">Case Solution</label>
                        <input  type="text" class="form-control" id="case_solution" name="case_solution" placeholder="case_solution"  autofocus>
                        <span class="text-danger"><?php echo form_error("case_solution"); ?></span>
                    </div>
                    <div class="form-label-group col-lg-4">
                        <label for="issue_date">Issue Date</label>
                        <input  type="date" class="form-control" id="issue_date" name="issue_date" placeholder="issue_date"  autofocus>
