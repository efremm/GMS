          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              <div class="navbar-header"><a id="toggle-btn" href="#" class="menu-btn"><i class="icon-bars"> </i></a><a href="index.html" class="navbar-brand">
                  <div class="brand-text d-none d-md-inline-block"><span>AAPC Garage  </span><strong class="text-primary">Managment System</strong></div></a></div>
        ...
        <div class="container">
          ...
          $value=$this->session->userdata('KEY');
            ?>
                  ...
                  <div class="col-lg-12"> <h4 style="font-family: sans-serif;">Update Password</h4></div>
                        <hr>
                ...
                <form   method="post" action="<?php echo base_url()?>Authentication/update_pass">
                ...
                <div class="container row">
                  ...
                  <div class="form-label-group col-lg-4">
                        ...
                        <input  type="text" class="form-control text-danger bg-warning" id="username" name="username" placeholder="username"  
                                                    autofocus    required>
                                  <!-- value="<?php echo $this->session->userdata('KEY');  ?>" --> 
                    </div>
                      ...
                      <div class="form-label-group col-lg-4">
                        ...
                        <input  type="password" class="form-control  text-danger" id="pass" name="pass" placeholder="pass" 
                          autofocus  required="">
                       </div>
                        <div class="form-label-group col-lg-4">
                        <label >Re-Enter Password </label>
                        <input  type="password" class="form-control  text-danger" id="repassword" name="repassword" placeholder="re enter password" 
                          autofocus  >
                       </div>
