  ...
  <body>
    ...
    <div class="page">
      ...
      <section class="dashboard-counts section-padding">
        <div class="container-fluid">
          <h3 class="text-primary">Manager Dashboard</h3>
          <div class="row">
            <!-- body-->
         ...
         <div class="container">
                   ...
                   <div class="col-lg-12">  
                  <h5 class="text-info">Approve Help Request by Driver</h5>
                  </div>
                     <hr>
                     <div class="container">
                            ...
                            <thead>
                              <tr>
                                ...
                                <th >requested_date</th>
                                 <!-- <th>vehicle_image</th> -->
                                <th >issue_status</th>
                                 <th >approval_descn</th>
                              <!--   <th class="text-danger">ApproveRequest</th> -->
                                   </tr>
                            </thead>
                            <tbody>
                              <?php if(count($posts)):?>
                              ...
                              <tr>
                                ...
                                <td><?php echo $post->requested_date;?></td>
                                <!-- <td><?php echo $post->vehicle_image;?></td> -->
                                <td class="text-info" ><?php echo $post->issue_status;?></td>
                                <td class="text-danger" ><?php echo $post->approval_description;?></td>
                              <!-- <td> <?php echo anchor("Manager_C/FetchUpdateRequest/{$post->request_id}",'<span class="fa fa-edit fa-lg" ></span>',['class'=>'btn btn-info']);?></td> -->
