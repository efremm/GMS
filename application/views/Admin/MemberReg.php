      ...
      <section class="dashboard-counts section-padding">
        <div class="container">
          <div class="row">
            ...
            <!-- body-->
               <form   method="post" action="<?php echo base_url()?>Encoder_C/add_member">
                 <div class="container row">
       <div class="col-lg-12"> <h4 style="font-family: sans-serif;">Employee Registration</h4></div>
           <hr>
          <div class="container  " style="background-color: green;">
              <?php if($scsmsg = $this->session->flashdata('successmsg'));?>
               ...
               <div class="form-label-group col-lg-4">
                        ...
                        <input type="text" class="form-control" id="title" name="title" placeholder="Insert title"  autofocus>
                  ...
                  <div class="form-label-group col-lg-4" >
                    ...
                    <div class="form-label-group col-lg-4">
                        ...
                        <input type="text" class="form-control" id="department" name="department" placeholder="department"  autofocus>
                        <span class="text-danger"><?php echo form_error("department"); ?></span>
                    </div>
                     <div class="form-label-group col-lg-4">
                        <label for="salary">salary</label>
                        <input type="text" class="form-control" id="salary" name="salary" placeholder="salary"  autofocus>
                    ...
                    <div class="form-label-group col-lg-4">
                        ...
                        <input type="date" class="form-control" id="registrationdate" name="registrationdate" placeholder="registrationdate"  autofocus>
                         <span class="text-danger"><?php echo form_error("registrationdate"); ?></span>
                    </div>
                    <div class="form-label-group col-lg-4">
                        <label for="hireddate">Hired Date</label>
                        <input type="date" class="form-control" id="hireddate" name="hireddate" placeholder="hireddate"  autofocus>
...
<!-- 
                    ...
                    <div class="form-label-group col-lg-4">
                     ...
                     <div class="form-label-group col-lg-4">
                        ...
                        <input type="text" class="form-control" id="licenceno" name="licenceno" placeholder="licenceno"  autofocus>
                        <span class="text-danger"><?php echo form_error("licenceno"); ?></span>
                    </div>
                   
                     
                    <div class="form-label-group col-lg-4">
                        <label for="licerendate">licence renwal date</label>
                        <input type="text" class="form-control" id="licerendate" name="licerendate" placeholder="licerendate"  autofocus>
                         <span class="text-danger"><?php echo form_error("licerendate"); ?></span>
                    </div>
                    <div class="form-label-group col-lg-4">
                        <label for="empid">employee id</label>
                        <input type="text" class="form-control" id="empid" name="empid" placeholder="empid"  autofocus>
