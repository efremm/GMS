      ...
      <section class="dashboard-counts section-padding">
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="container">
                      <!--  <div class="col-lg-12">  
                   <?php echo anchor('Reception_C/ServiceDetailReg','Add Detail',['class'=>'btn btn-info']);?>
                  </div> -->
                     ...
                     <div class="container">
                          <table id="tbluser"  name="tbluser" class="table table-responsive table-striped table-bordered" style="width:100%">
                            <thead>
                              <tr>
                                <th >detail_service_id</th>
                                <th >plate_no</th>
                                <th >service_no</th>
                                 <th>main_problem</th>
                                <th >assigned_to</th>
                                <th >service_type</th>
                                <th >maintained_part</th>
                            ...
                            <tbody>
                              ...
                              <tr>
                               ...
                               <!--  <td> <?php echo anchor("Reception_C/service_assignment_fetch/{$post->detail_service_id}",'<span class="fa fa-edit"></span>',['class'=>'btn btn-warning']);?></td>  -->
