      ...
      <section class="dashboard-counts section-padding">
        <div class="container-fluid">
         ...
         <div class="container">
                   ...
                   <div class="col-lg-12">  
                   <?php echo anchor('StoreKeeper_C/AccessoryReg','Add Accessory',['class'=>'btn btn-info']);?>
                  </div>
                     <hr>
                     <div class="container">
                          <table id="tbluser"  name="tbluser" class="table table-responsive table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td><?php echo $post->part_no;?></td>
                                <td><?php echo $post->unit_price;?></td>
                                <td><?php echo $post->quantity;?></td>
                                <td><?php echo $post->received_date;?></td>
                               
                              <td> <?php echo anchor("StoreKeeper_C/FetchUpdateAccessory/{$post->item_id}",'<span class="fa fa-edit"></span>',['class'=>'btn btn-info']);?></td>
                                 <td> <a class="delete_data btn btn-danger" href="#" id="<?php echo $post->item_id; ?>"><span class="fa fa-trash"></span></a> </td>
