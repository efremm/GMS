    ...
    <nav class="side-navbar">
      <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
         ...
         <!--  <li> <a class="fa fa-bus" href="<?php echo base_url('StoreKeeper_C/AccessoryManage')?>"><i class=""></i>Assign Technician</a></li> -->
      ...
      <section class="dashboard-counts section-padding">
        <div class="container">
          <div class="row">
            ...
            <!-- body-->
               <form   method="post" action="<?php echo base_url()?>Technician_C/SubmitServiceDetail">
                 <div class="container row">
       <div class="col-lg-12"> <h4 style="font-family: sans-serif;"> service reg form</h4></div>
           <hr>
          <div class="container  " style="background-color: green;">
              <?php if($scsmsg = $this->session->flashdata('successmsg'));?>
               ...
               <div class="form-label-group col-lg-4">
                        <label for="plateno">plate_no</label>
                        <input type="text" class="form-control" id="plateno" name="plateno" placeholder="Insert licence no"  autofocus>
                        <span class="text-danger"><?php echo form_error("plateno"); ?></span>
                    </div>
                 
                    <div class="form-label-group col-lg-4">
                        <label for="serviceno">service_no</label>
                        <input type="text" class="form-control" id="serviceno" name="serviceno" placeholder="serviceno"  autofocus>
                        <span class="text-danger"><?php echo form_error("serviceno"); ?></span>
                    </div>
                     <div class="form-label-group col-lg-4">
                        <label for="mainproblem">main_problem</label>
                        <input class="form-control" id="mainproblem" name="mainproblem" placeholder="mainproblem"  autofocus>
                        <span class="text-danger"><?php echo form_error("mainproblem"); ?></span>
                    </div>
                    
                    <div class="form-label-group col-lg-4" >
                        <label for="assignedto">technician</label>
                        <select class="form-control text-success"  id="assignedto" name="assignedto">
                    ...
                    <?php
                       ...
                       <div class="form-label-group col-lg-4" readonly>
                        ...
                        <select class="form-control text-danger" id="servicetype" name="servicetype" >
                            
                              <option >-select service type-</option>
                            <option class="text-success" value="High">High</option>
                            <option class="text-success" value="Low">Low</option>
                             <option class="text-success" value="Medium">Medium</option>
                            

                        </select>
                        <span class="text-danger"><?php echo form_error("servicetype"); ?></span>
                    </div>

                    <div class="form-label-group col-lg-4" readonly>
                        <label for="maintainedpart">maintained_part</label>
                        <select class="form-control text-success" id="maintainedpart" name="maintainedpart" >
                            
                            <option >-select maintainedpart-</option>
                            <option value="Fully Body">Full Body</option>
                            <option value="Interior">Interior</option>
                             <option value="External">External</option>


                        </select>
                        <span class="text-danger"><?php echo form_error("maintainedpart"); ?></span>
                    </div>
