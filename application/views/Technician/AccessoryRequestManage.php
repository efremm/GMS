                     ...
                     <div class="container">
                          <table id="tbll"  name="tbll" class="table table-responsive table-striped table-bordered" style="width:100%">
                            <thead>
                              <tr>
                               ...
                               <th class="text-success">approved quantity</th>
                                ...
                                <th class="bg-warning">Request Accessory</th>
                            ...
                            <tbody>
                              ...
                              <td> <?php echo anchor("Technician_C/AccessoryRequest/{$post->item_id}",'<span class="fa fa-check"></span>',['class'=>'btn btn-info']);?></td>
