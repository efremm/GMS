          ...
          <div class="row">
            <!-- body-->
                ...
                <?php if($scsmsg = $this->session->flashdata('successmsg'));?>
                  ...
                  Register Detail Vehicle Problem
                  </div>
     
            <div class="container">
       
                     <div class="col-lg-12">  
                   <?php echo anchor('Technician_C/ServiceDetailReg','Add Detail',['class'=>'btn btn-info']);?>
                  </div>
                     <hr>
                           <div class="container">
                          <table id="tbll"  name="tbll" class="table table-responsive table-striped table-bordered" style="width:100%">
                            <thead>
                              <tr>
                                <th >detail service id</th>
                                <th >plate no</th>
                                <th >service no</th>
                                 <th>main problem</th>
                                <th >assigned to</th>
                                <th >service type</th>
                                <th >maintained part</th>
                                <th class="text-info">assigned to</th>
                                 <!-- <th class="text-warning">Update</th> -->
                                 <th class="text-danger">Delte</th>
                                    </tr>
                            </thead>
                            <tbody>
                              <?php if(count($posts)):?>
                              ...
                              <tr>
                                <td><?php echo $post->detail_service_id;?></td>
                                <td><?php echo $post->plate_no; ?></td>
                                <td><?php echo $post->service_no;?></td>
                                <td><?php echo $post->main_problem;?></td>
                                <td><?php echo $post->assigned_to;?></td>
                                <td><?php echo $post->service_type;?></td>
                                <td><?php echo $post->maintained_part;?></td>
                                 <td class="text-info"><?php echo $post->assigned_to;?></td>
                           
                               <!--  <td> <?php echo anchor("Technician_C/service_assignment_fetch/{$post->detail_service_id}",'<span class="fa fa-edit"></span>',['class'=>'btn btn-warning']);?></td>  -->
                                 <td> <a class="delete_data btn btn-danger" href="#" id="<?php echo $post->detail_service_id; ?>"><span class="fa fa-trash"></span></a> </td>
  ...
  <script type="text/javascript">
       $(document).ready(function() {
          $('.delete_data').click(function()
           {
            var servicedata=$(this).attr("id");
            if(confirm("Are you sure you want to delete this"))
                {
                   window.location="<?php echo base_url(); ?>Technician_C/delete_service_c/"+servicedata;
                }     
                else
                {
                  return false;
