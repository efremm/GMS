      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
           <li><a href="<?php echo base_url('Encoder_C/home')?>"> <i class="fa fa-home"></i>Home                             </a></li>
        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="container">
                   ...
                   <div class="col-lg-12">  
                   <?php echo anchor('Encoder_C/MemberReg','Add Employee',['class'=>'btn btn-info']);?>
                  </div>
                     <hr>
                     <div class="container">
                          <table id="tbll"  name="tbll" class="table table-responsive table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td><?php echo $post->registration_date;?></td>
                                <td><?php echo $post->hired_date;?></td>                          
                              <td> <?php echo anchor("Encoder_C/update_member_fetch/{$post->member_id}",'<span class="fa fa-edit"></span>',['class'=>'btn btn-info']);?></td>
                                 <td> <a class="delete_data btn btn-danger" href="#" id="<?php echo $post->member_id; ?>"><span class="fa fa-trash"></span></a> </td>
                                </tr>
                            <?php endforeach;?>
                            <?php else: ?>
                              <tr>
  ...
  <script type="text/javascript">
       $(document).ready(function() {
          $('.delete_data').click(function()
           {
            var driverdata=$(this).attr("id");
            if(confirm("Are you sure you want to delete this"))
                {
                   window.location="<?php echo base_url(); ?>Encoder_C/delete_member_c/"+driverdata;
                }     
                else
                {
                  return false;
