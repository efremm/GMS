      ...
      <section class="dashboard-counts section-padding">
        <div class="container">
          <div class="row">
            ...
            <!-- body-->
              <form   method="post" action="<?php echo base_url()?>Encoder_C/update_driver">
                 <div class="container row">
                  <div class="col-lg-12"> <h4 style="font-family: sans-serif;">Edit Driver Data</h4></div>
                        <hr>
                   ...
                   if(isset($fetch_data))
                     ...
                     <div class="form-label-group col-lg-4">
                        ...
                        <input  type="text" class="form-control text-danger" id="driverid" name="driverid" placeholder="driverid"  autofocus readonly="" value="<?php echo $row->driver_id; ?>"  >
                        <span class="text-danger"><?php echo form_error("driverid"); ?></span>
                    </div>
                   
                  <div class="form-label-group col-lg-4">
                        <label for="licenceno">licence_no</label>
                        <input  type="text" class="form-control" id="licenceno" name="licenceno" placeholder="licenceno"  autofocus value="<?php echo $row->licence_no; ?>"  >
                        <span class="text-danger"><?php echo form_error("licenceno"); ?></span>
                    </div>
                  <div class="form-label-group col-lg-4">
                    ...
                    <div class="form-label-group col-lg-4" >
                      ...
                      <div class="form-label-group col-lg-4">
                        <label for="licencerenewaldate">licence renewal date</label>
                        <input  type="text" class="form-control" id="licencerenewaldate" name="licencerenewaldate" placeholder="licencerenewaldate"  autofocus value="<?php echo $row->licence_renewal_date; ?>" >
                        <span class="text-danger"><?php echo form_error("licencerenewaldate"); ?></span>
                    </div>
            
                    <div class="form-label-group col-lg-4">
                        <label for="address">address</label>
                        <input  type="text" class="form-control" id="address" name="address" placeholder="address"  autofocus value="<?php echo $row->address; ?>" >
                        <span class="text-danger"><?php echo form_error("address"); ?></span>
                    </div>
                    <div class="form-label-group col-lg-4">
                        <label for="phoneno">phone no</label>
                        <input  type="text" class="form-control" id="phoneno" name="phoneno" placeholder="phoneno"  autofocus value="<?php echo $row->phone_no; ?>" >
                    ...
                    <div class="form-label-group col-lg-4">
                        ...
                        <span class="text-danger"><?php echo form_error("hireddate"); ?></span>
                         ...
                         <input type="hidden" name="hidden_id" value="<?php  echo $row->driver_id;?>" required>
                        <input type="submit" value="Update" class="btn btn-info" name="update"/>

                            <?php echo anchor('Encoder_C/DriverManage','Back',['class'=>'btn btn-defualt']);?>
