            ...
            <!-- body-->
              <form   method="post" action="<?php echo base_url()?>Encoder_C/update_member">
                 <div class="container row">
                  <div class="col-lg-12"> <h4 style="font-family: sans-serif;">Edit Member Data</h4></div>
                        <hr>
                  ...
                  <div class="form-label-group col-lg-4" >
                    ...
                    <div class="form-label-group col-lg-4">
                        ...
                        <input  type="date" class="form-control" id="registrationdate" name="registrationdate" placeholder="registrationdate"  autofocus value="<?php echo $row->registration_date; ?>" >
                        <span class="text-danger"><?php echo form_error("registrationdate"); ?></span>
                    </div>
                    <div class="form-label-group col-lg-4">
                        <label for="hireddate">hired date</label>
                        <input  type="date" class="form-control" id="hireddate" name="hireddate" placeholder="hireddate"  autofocus value="<?php echo $row->hired_date; ?>" >
