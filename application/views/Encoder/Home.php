...
<div class="container">
    ...
    <div class="row col-lg-12" style="background-color: grey;">
                    <p><h3><strong>
                      Data Encoder Dashboard</strong></h3>
                    </p>
                  </div>
                  <hr>
    ...
    <div class="row col-lg-12">
        <div class="card text-white bg-primary col-lg-3">
            <div class="card-header">Operational Profile</div>
            <div class="card-body">
                <h4 class="card-title">Operational Detail</h4>
      ...
      <div class="card text-white bg-primary col-lg-3">
            <div class="card-header"> Recorded Information</div>
            <div class="card-body">
                <h4 class="card-title"> Recorded Detail</h4>
