...
• Battery is drained overnight
    ...
    <div class="container">
                   ...
                   <div class="col-lg-12">  
                <!--    <?php echo anchor('Admin_C/creat_case','Add Case',['class'=>'btn btn-info']);?> -->
                  </div>
                     <hr>
                     <div class="container">
