      ...
      <div class="side-navbar-wrapper">
        ...
        <hr>
          <ul id="side-admin-menu" class="side-menu list-unstyled"> 
            <li> <a class="fa fa-bus" href="<?php echo base_url('Encoder_C/SystemHelp')?>"><i class=""></i>Help</a></li>
      ...
      <section class="dashboard-counts section-padding">
        <div class="container-fluid">
          <div class="col-lg-12 bg-info">  
                  <span class=""> Vehicle Managment</span>
                  </div>
          <div class="row">
            <!-- body-->
            ...
            <div class="container">
                   ...
                   <div class="col-lg-12">  
                   <?php echo anchor('Encoder_C/VehicleReg','Add Vehicle',['class'=>'btn btn-info']);?>
                  </div>
                     <hr>
                     <div class="container">
                          <table id="tbll"  name="tbll" class="table table-responsive table-striped table-bordered" style="width:100%">
                            ...
                            <tbody>
                              ...
                              <td> <?php echo anchor("Encoder_C/update_vehicle_fetch/{$post->plate_no}",'<span class="fa fa-edit"></span>',['class'=>'btn btn-info']);?></td>
